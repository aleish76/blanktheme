				...
				//add toolbar
				 ...
				 //set theme changer
					...
					if (theme_coo) {
					   ...
					   jQuery('#editortheme').append('<option>cobalt</option>');
					   jQuery('#editortheme').append('<option>eclipse</option>');
					   jQuery('#editortheme').append('<option>monokai</option>');
					   jQuery('#editortheme').append('<option>rubyblue</option>');
					   jQuery('#editortheme').append('<option>solarizedDark</option>');
					   jQuery('#editortheme').append('<option>solarizedLight</option>');
					}
