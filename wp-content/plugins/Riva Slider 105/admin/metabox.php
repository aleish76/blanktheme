...
function riva_slider_pro_metabox() {
    ...
    if ( function_exists( 'add_meta_box' ) && riva_slider_pro_check_caps( 'rivasliderpro_view_metabox' ) ) {
...
function riva_slider_pro_metabox_code( $post, $metabox ) {
    ...
    <div class="misc-pub-section" style="border-top-width: 0px; padding: 5px 0px;">
        ...
        <?php if ( riva_slider_pro_check_caps( 'rivasliderpro_edit_metabox' ) ) { ?>
        ...
        switch ( $value[ 'type' ] ) {
            ...
            case 'text' : ?>
                <div class="misc-pub-section rs-<?php echo esc_attr( $value[ 'id' ] ); ?>">
                    ...
                    <input type="text" name="<?php echo esc_attr( $value[ 'id' ] ); ?>" id="<?php echo esc_attr( $value[ 'id' ] ); ?>" value="<?php if ( isset( $data[ $value[ 'id' ] ] ) && $data[ $value[ 'id' ] ] != '' ) { echo esc_attr( $data[ $value[ 'id' ] ] ); } else { echo $value[ 'std' ]; } ?>" />
...
function riva_slider_pro_meta_save( $post_id ) {
    ...
    if ( riva_slider_pro_check_caps( array( 'rivasliderpro_view_metabox' , 'rivasliderpro_edit_metabox' ) ) ) :
